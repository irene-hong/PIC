...
import { formatDateCHN, formatDate } from "../../utils/formatDate";

import { addLike } from "../../actions/post";
import { clearPost } from "../../actions/post";
import { getSinglePost } from "../../actions/post";

const Post = ({ getSinglePost, clearPost, post: { post, loading }, match }) => {
  useEffect(() => {
  ...
  return loading || post == null ? (
    ...
    <Fragment>
      <div className="single-post bg-white p-1 my-1">
        <Link to="/posts" className="btn my-1" onClick={clearPost}>
          返回首页
        </Link>
...
export default connect(mapStateToProps, { getSinglePost, clearPost })(Post);
